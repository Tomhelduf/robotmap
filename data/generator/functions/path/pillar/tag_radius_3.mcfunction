...
execute at @s run function generator:path/pillar/draw_3
...
execute at @s as @e[type=minecraft:area_effect_cloud,tag=new,sort=nearest,limit=1] run function generator:path/pillar/tag_radius_3
